...
allHrsArray.forEach((e) => (e.style.borderRadius = "5px"));
...
allHrsArray
	.filter((e) => e.className == "image")
	.forEach((e) => (e.style.border = `2px solid purple`));
...
allHrsArray.forEach((e) => (e.style.borderStyle = "dashed"));
...
[...box1.children].forEach((e) => e.remove());
...
const box16 = document.querySelector(".sixteen");
...
document.querySelector(".two").append(box2para);
...
box3para.innerText = "Prepend inserts as first child";
document.querySelector(".three").prepend(box3para);
...
[...document.querySelectorAll(".box")]
	.filter((e, i) => i % 2 === 0)
	.forEach((e) => (e.style.backgroundColor = "aliceblue"));
...
[...box7.children].forEach((e) => e.remove());
...
const altcampus = document.createElement("a");
